        ...
        <nav class="destop_header navbar navbar-expand-lg navbar-light bg-light">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item">
                <a class="logo_main" href="index.jsp"><img src="images/logo.jpg"></a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                ...
                <ul class="dropdown-nav nav-item" id="loginOptions">
                    <li><a href="./login-v2.jsp">Admin</a></li>
                    <li><a href="./register.jsp">Doctor</a></li>
                    <li><a href="./register.jsp">Patient</a></li>
                </ul>
            </li>          
            </ul>
          </div>
