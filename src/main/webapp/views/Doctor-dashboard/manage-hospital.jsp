...
<head>
	...
	<link rel="stylesheet" href="/d_style-1.css">
	...
	<main>
		<div class="container">
            ...
            <table class="table">
              ...
              <tbody>
                <tr>
                  <td>John Doe Hospital</td>
                  <td>John Doe</td>
                  <td>Monday-Friday, 9am-5pm</td>
                  <td><button class="btn btn-primary">Change Time</button></td>
                </tr>
                <tr>
                  <td>Jane Doe Hospital</td>
                  <td>Jane Doe</td>
                  <td>Tuesday-Saturday, 10am-6pm</td>
                  <td><button class="btn btn-primary">Change Time</button></td>
                </tr>
              </tbody>
            </table>
